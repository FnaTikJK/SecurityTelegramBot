...
namespace ObjectDetection
{
    public class Neiroweb
    {
        ...
        IEnumerable<ImageNetData> images;
        ...
        {
            //return isPersonOnPhoto
            bool isPersonOnPhoto = false;
            ...
            {
                // Load Data
                images = ImageNetData.ReadFromFile(imagesFolder);
                imageDataView = mlContext.Data.LoadFromEnumerable(images);

                // Create instance of model scorer
                modelScorer = new OnnxModelScorer(imagesFolder, modelFilePath, mlContext);
                ...
                for (var i = 0; i < images.Count(); i++)
                {
                    ...
                    foreach (var e in detectedObjects)
                    {
                        if (e.Label == "person")
                            flag = true;
                    }
